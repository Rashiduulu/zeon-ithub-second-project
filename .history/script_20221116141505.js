...
const addToFavorite = (btn) => {
  ...
  console.log(btn.dataset.pokemonId, btn.dataset.image, btn.dataset.name);
  const productInfo = {
    id: btn.dataset.pokemonId,
    image: btn.dataset.image,
    name: btn.dataset.name,
    weight: btn.dataset.name,
  };
    ...
    .map(
      (poke) =>
        ...
        <div class="right-side">
         ...
         <div onclick="addToFavorite(this)" data-pokemon-id="${poke.id}" data-image="${poke.image}" data-name="${poke.name}",data-name="${poke.weight}">
