...
const pokeDetailsContent = document.querySelector(".poke-details");
...
closeBtn.addEventListener("click", () => {
  pokeDetailsContent.parentElement.classList.remove("showRecipe")
}) 

function pokeRecipeModal(data) {
  console.log(data);
  meal = data[0];
  let html = `
  ...
  pokeCard.parentElement.classList.add("showRecipe");
}
