...
const addToFsvorite = (btn) => {
  ...
  console.log(localPokes);
    if (localPokes) {
      localStorage.setItem("favorites", JSON.stringify([...localPokes, btn.dataset.pokemonId]));
    } else {
    ...
    .map(
      (poke) =>
        ...
        <div class="right-side">
         ...
         <button onclick="addToFsvorite(this)" data-pokemon-id="${poke.id} data-image="${poke.image} data-name="${poke.}">
