    ...
    .map(
      (poke) =>
        ...
        <div class="right-side">
         ...
         <div onclick="addToFavorite(this)" data-pokemon-id="${poke.id}" data-image="${poke.image}" data-name="${poke.name}" data-weight="${poke.weight} data-type="${poke.types[0].type.name}" ">
