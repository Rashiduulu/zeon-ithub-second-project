...
const sortPokemons = document.querySelector(".sort-poke");

sortPokemons.addEventListener("click", getPokeInfo);

const sortPoke = (pokemon) => {
  let sort = pokemon;
  sort.sort((a, b) => {
  ...
  sort.forEach((poke) => {
    ...
    <div class="right-side">
      ...
      <div
        ...
        data-image="${poke.image}"
        data-name="${poke.name}"
        data-weight="${poke.weight}"
        data-type="${poke.type}"
      >
