...
const addToFavorite = (btn) => {
  ...
  console.log(btn.dataset.pokemonId, btn.dataset.image, btn.dataset.name, btn.dataset.weight);
  const productInfo = {
    ...
    .map(
      (poke) =>
        ...
        <div class="right-side">
         ...
         <div onclick="addToFavorite(this)" data-pokemon-id="${poke.id}" data-image="${poke.image}" data-name="${poke.name}" data-weight="${poke.weight} data-type="${data.types[0].type.name}" ">
