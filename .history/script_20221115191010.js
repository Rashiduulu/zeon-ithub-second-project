    ...
    .map(
      (poke) =>
        ...
        <div class="right-side">
         <a oncl class = "info-btn">info</a>
          <a href = "./FavoritePage/Favorite.html" class = "info-btn">
           <img class="add-to-fav" src="./imgs/liked.png" /> </a>
        </div>
    </div>`
    )
    .join("");
...
const openFavorite = () => window.open('./FavoritePage/Favorite.html', '_self')
getPokemons(offset, limit);
