...
const showPokemon = (pokemon) => {
  ...
  const pokemonHTML = pokemon
    .map(
      (poke) => {
        const addToFsvorite = () => {
          console.log("asdasd,", poke);
          localStorage.setItem("favorites", JSON.stringify(poke));
        };
        
        return `<div class="card" data-id = "${poke.id}"> 
        <div class="left-side">
        ...
        <div class="right-side">
         ...
         <button onclick="addToFsvorite(this)" class="add-favorite-btn">
